...
A robotics competition project focused on building a four-wheel rescue robot capable of operating in danger-prone environments and retrieving hostages/objects using a gripper mechanism. The system combines embedded control, video streaming, and mechanical design to simulate rescue operations.

## Project Overview

The Autonomous Rescue Bot is designed to simulate rescue operations in hazardous areas where human access is limited. The robot is remotely operated, features a gripping arm for object retrieval, and provides real-time video feedback for navigation and control.
...
- Serial/GPIO communication between components
...
- Fully custom circuit and mechanical design
...
- Raspberry Pi streams live video from the webcam.
